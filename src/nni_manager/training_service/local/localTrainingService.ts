...
class LocalTrainingService implements TrainingService {
    ...
    private trialConcurrency:string; //ouyang
    ...
    public async setClusterMetadata(key: string, value: string): Promise<void> {
        ...
        switch (key) {
            ...
            case TrialConfigMetadataKey.MULTI_PHASE:
                ...
                break;
            case TrialConfigMetadataKey.TRIAL_CONCURRENCY: //ouyang
                this.trialConcurrency = value;
                break;
            default:
        }
    }
    ...
    private getEnvironmentVariables(
        ...
        const envVariables: { key: string; value: string }[] = [
            ...
            { key: 'TRIAL_CONCURRENCY', value: this.trialConcurrency.toString() } //ouyang       
        ];
        if (gpuNum !== undefined) {
            envVariables.push({
